...
export const getProduct =
  (keyword = "", currentPage = 1, price = [0, 15000], category, ratings = 0) =>
  async (dispatch) => {
    try {
      ...
      console.log("file: productAction.js ~ line 33 ~ data", data);
      dispatch({ type: ALL_PRODUCT_SUCCESS, payload: data });
    } catch (error) {
      console.log("file: productAction.js ~ line 35 ~ error", error);
      dispatch({
